	...
	<table class="table table-striped">
		...
		<tr>
			...
			<td class="text-end">
				...
				<div class="d-lg-none">
					<a href="{{ route('administrators/patients/edit', $patient->id) }}" class="btn btn-info btn-sm mt-1" title="{{ trans('patients.show_patient') }}" > <i class="fas fa-user-edit fa-sm"></i> </a>
