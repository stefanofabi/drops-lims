...
<nav class="navbar">
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('administrators/profiles/edit', ['id' => $user->id]) }}"> {{ trans('forms.go_back') }} </a>
        </li>
    </ul>
</nav>
@endsection
...
@section('content')
<form method="post" action="{{ route('administrators/profiles/change_password/update', $user->id) }}">
    @csrf
    @method('PUT')
        ...
        <div class="col-md-6">
            <div class="form-group mt-2">
                ...
                <input type="text" class="form-control @error('current_password') is-invalid @enderror" name="current_password" id="current_password" value="{{ old('current_password') }}" aria-describedby="currentPasswordHelp" required>
        ...
        <div class="col-md-6">
            <div class="form-group mt-2">
                ...
                <input type="text" class="form-control @error('new_password') is-invalid @enderror" name="new_password" id="new_password" value="{{ old('new_password') }}" aria-describedby="newPaswordHelp" required>
        ...
        <div class="col-md-6">
            <div class="form-group mt-2">
                ...
                <input type="text" class="form-control @error('new_password_confirmation') is-invalid @enderror" name="new_password_confirmation" id="new_password_confirmation" value="{{ old('new_password_confirmation') }}" aria-describedby="newPasswordConfirmationHelp" required>
