        ...
        <div class="col-10">
            <div class="mt-3">
                ...
                <div class="input-group mt-2">
                    ...
                    <input type="text" class="form-control" id="patientAutoComplete" placeholder="{{ trans('forms.start_typing') }}" value="@if ($patient) {{ $patient->last_name ?? '' }} {{ $patient->name ?? '' }} @endif" required>
                </div>
